# Source: https://github.com/Jmkernes/SentencePiece-from-scratch/blob/main/sentence_piece.py
...
class SentencePieceTrainer:
    ...
    def fit(self, text, tokens, characters, vocab_size=10, delta=0.01, max_iter=50, max_rounds=50):
